    ...
    <div className='demo-inline-spacing'>
      <div>
        ...
        <Modal isOpen={formModal} toggle={() => setFormModal(!formModal)} className='modal-dialog-centered'>
          <ModalHeader toggle={() => setFormModal(!formModal)}>Formulario</ModalHeader>
          <ModalBody>
            <div className='mb-2'>
      ...
      <div>
        ...
        <Modal isOpen={firstModal} toggle={() => setFirstModal(!firstModal)} className='modal-dialog-centered'>
          <ModalHeader toggle={() => setFirstModal(!firstModal)}>Reegistro creado con exito </ModalHeader>
          <ModalBody>El registro se ha creado corretamente.</ModalBody>
          <ModalFooter>
